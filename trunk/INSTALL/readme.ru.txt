...
3.1. Выполнить record_alter.sql. Там все необходимые поля для разных игр бнета, которых нет в базе по-умолчанию, но используются pvpgn'ом. В логах пвпгна без них иногда возникают ошибки при попытке записи.
